...
$(document).ready(function() {
	...
	$(".visibleTag").each(function() {
		...
		const tagVal = getQueryString(tag);
		console.log("tag=" + tag + " tagVal=" + tagVal);
		if (tagVal) {
			$(this).css("display", "");
		} else {
